...
export const logEntries: LogEntry[] = [
  {
    slug: "launch-day-corrections",
    date: "2026-09-14",
    title: "Launch day, second pass: audit fixes, one voice, and the résumé regenerated",
    product: "site",
    kind: "release",
    what: "Six commits landed on main after the launch. A site audit (pull request #58) shared one masthead across every page, shortened the phone hero, collapsed receipts into expandable sources with clickable public URLs, gave demo clips controls, moved the start form to neutral defaults, and bumped Trendi to 0.2.2 and Way In to 1.0.1 from Apple's Lookup API. Then the founder copy stopped naming a former employer and names the sports-betting market instead, the portrait was recropped and shown in its own colour, the résumé PDF was regenerated from the same data, the home lede went back to the studio's third-person voice after the audit had left it in first person, the visual smoke scripts were repointed at the shared masthead, and 124 lines of the home page's retired masthead CSS came out.",
    why: "A launch is the first version strangers see, not the last one. Two sessions were editing the site on the same day, and the record should say what each changed and that the audit's version numbers were checked against the store, not assumed.",
    next: "Decide, deliberately, whether receipts stay collapsed by default; the audit made that call under the heading of a fix. Get the GitHub Actions billing lock lifted so the next change runs CI instead of a local reproduction.",
    evidence: [
      { claim: "The audit merged to main", source: "https://github.com/koinophobia-labs/koinophobia-labs-site/pull/58, merged 2026-09-14 as 444f447" },
      { claim: "Store versions match Apple", source: "Apple Lookup API checked 2026-09-14: Trendi: Content Coach 0.2.2 (released 2026-09-10), Way In: Career Hub 1.0.1 (released 2026-09-10), ForgetAboutIt 1.0" },
      { claim: "The copy, portrait, and résumé changes are on main", source: "koinophobia-labs-site commits c07f96e, b67daad, 786be8f, 2026-09-14; public/resume/Blake-Taylor-Resume.pdf regenerated by scripts/generate-resume-pdf.py" },
      { claim: "The voice fix, smoke scripts, and CSS removal are on main", source: "koinophobia-labs-site commits efd9265 and aabda03, 2026-09-14; scripts/capture-koi-world.mjs passed all six captures against a production build in Chrome" },
    ],
  },
  {
