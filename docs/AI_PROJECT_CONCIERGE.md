...
The koi has no circular button backing. Its visual presence comes from the branded fish silhouette, a subtle body/tail swimming cycle, and two fading wake strokes. Focus remains visible through the cyan accessibility outline rather than a persistent container.
